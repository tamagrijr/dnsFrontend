...
export default function SmokeParticle({ w, h, baseSixtyFour }) {
  useEffect(() => {
    ...
    //USE THIS SITE TO CONVERT IMAGE TO BASE 64 () https://onlinepngtools.com/convert-png-to-base64
...
top: 50%;
left: 50%;
${props => props.w ? `width: ${props.w}px;` : `width: 300px;`}
${props => props.h ? `height: ${props.h}px;` : `height: 300px;`}
